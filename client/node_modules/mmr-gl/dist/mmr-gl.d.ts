...
import { Color, CompositeExpression, Feature, FeatureFilter, FeatureState, FilterSpecification, Formatted, FormattedSection, GeoJSONSourceSpecification, GlobalProperties, ICanonicalTileID, IMercatorCoordinate, ImageSourceSpecification, InterpolationType, LayerSpecification, LightSpecification, Padding, PromoteIdSpecification, PropertyValueSpecification, RasterDEMSourceSpecification, RasterSourceSpecification, ResolvedImage, SourceExpression, SourceSpecification, SpriteSpecification, StylePropertyExpression, StylePropertySpecification, StyleSpecification, TerrainSpecification, TransitionSpecification, VariableAnchorOffsetCollection, VectorSourceSpecification, VideoSourceSpecification } from 'mmr-gl-style-spec';
...
export declare class RequestManager {
	...
	_stylePath?: StyleSpecification | string;
	_transformRequestFn?: RequestTransformFunction;
	constructor(transformRequestFn?: RequestTransformFunction, customAccessToken?: string, stylePath?: string);
 ...
 * @example
 * ```ts
 * let v1 = new mmrgl.LngLat(-122.420679, 37.772537);
...
export declare class LngLat {
	 ...
	 * @example
	 * ```ts
	 * let ll = new mmrgl.LngLat(286.0251, 40.7736);
	 * let wrapped = ll.wrap();
	 * wrapped.lng; // = -73.9749
	 * ```
	 */
	 ...
	 * @example
	 * ```ts
	 * let ll = new mmrgl.LngLat(-73.9749, 40.7736);
	 ...
	 * @example
	 * ```ts
	 * let new_york = new mmrgl.LngLat(-74.0060, 40.7128);
	 * let los_angeles = new mmrgl.LngLat(-118.2437, 34.0522);
	 ...
	 * let ll = mmrgl.LngLat.convert(arr);
...
export declare class MercatorCoordinate implements IMercatorCoordinate {
	 ...
	 * @example
	 * ```ts
	 * let coord = mmrgl.MercatorCoordinate.fromLngLat({ lng: 0, lat: 0}, 0);
	 ...
	 * @example
	 * ```ts
	 * let coord = new mmrgl.MercatorCoordinate(0.5, 0.5, 0);
	 ...
	 * @example
	 * ```ts
	 * let coord = new mmrgl.MercatorCoordinate(0, 0, 0.02);
 ...
 * @example
 * ```ts
 * let v1 = new mmrgl.LngLatBounds(
 *   new mmrgl.LngLat(-73.9876, 40.7661),
 *   new mmrgl.LngLat(-73.9397, 40.8002)
 * );
 * let v2 = new mmrgl.LngLatBounds([-73.9876, 40.7661], [-73.9397, 40.8002])
...
export declare class LngLatBounds {
	 ...
	 * @example
	 * ```ts
	 * let sw = new mmrgl.LngLat(-73.9876, 40.7661);
	 * let ne = new mmrgl.LngLat(-73.9397, 40.8002);
	 * let llb = new mmrgl.LngLatBounds(sw, ne);
	 * ```
	 * OR
	 * ```ts
	 * let llb = new mmrgl.LngLatBounds([-73.9876, 40.7661, -73.9397, 40.8002]);
	 * ```
	 * OR
	 * ```ts
	 * let llb = new mmrgl.LngLatBounds([sw, ne]);
	 ...
	 * @example
	 * ```ts
	 * let llb = new mmrgl.LngLatBounds(
	 *   new mmrgl.LngLat(-73.9876, 40.7661),
	 *   new mmrgl.LngLat(-73.9397, 40.8002)
	 * );
	 *
	 * let ll = new mmrgl.LngLat(-73.9567, 40.7789);
	 *
	 ...
	 * let llb = mmrgl.LngLatBounds.convert(arr); // = LngLatBounds {_sw: LngLat {lng: -73.9876, lat: 40.7661}, _ne: LngLat {lng: -73.9397, lat: 40.8002}}
	 * ```
	 */
	 ...
	 * @example
	 * ```ts
	 * let center = new mmrgl.LngLat(-73.9749, 40.7736);
	 * mmrgl.LngLatBounds.fromLngLat(100).toArray(); // = [[-73.97501862141328, 40.77351016847229], [-73.97478137858673, 40.77368983152771]]
	 * ```
	 */
...
export declare class LineStyleLayer extends StyleLayer {
	...
	constructor(layer: LayerSpecification);
	_handleSpecialPaintPropertyUpdate(name: string): void;
	gradientExpression(): import("mmr-gl-style-spec").StylePropertyExpression;
	recalculate(parameters: EvaluationParameters, availableImages: Array<string>): void;
 ...
 * ```ts
 * // Initialize the map
 * let map = new mmrgl.Map({ // map options });
 ...
 * default control styling, add the `mmrgl-ctrl` class to your control's
 * node.
 *
 * @example
...
export declare class Map extends Camera {
	 ...
	 * let navigation = new mmrgl.NavigationControl();
	 * // Add zoom and rotation controls to the map.
...
export declare class Popup extends Evented {
	 ...
	 * @example
	 * ```ts
	 * let popup = new mmrgl.Popup().addTo(map);
	 * popup.remove();
	 * ```
	 * @returns `this`
	 */
	 ...
	 * @example
	 * ```ts
	 * let popup = new mmrgl.Popup({ closeOnClick: false, closeButton: false })
...
export declare class Marker extends Evented {
	 ...
	 * @example
	 * ```ts
	 * let marker = new mmrgl.Marker().addTo(map);
	 * marker.remove();
	 * ```
	 * @returns `this`
	 */
...
export declare class GeolocateControl extends Evented implements IControl {
	 ...
	 * let geolocate = new mmrgl.GeolocateControl({
	 *  positionOptions: {
...
export declare class MapLibreGL {
	 ...
	 * @example
	 * ```ts
	 * mmrgl.setRTLTextPlugin('https://unpkg.com/@mapbox/mapbox-gl-rtl-text@0.2.3/mapbox-gl-rtl-text.js');
	 * ```
	 ...
	 * times in some situations. `mmrgl.workerUrl` and `mmrgl.workerCount`, if being
	 ...
	 * `mmrgl.clearPrewarmedResources()`. This is only necessary if your web page remains
	...
	/**
	 * Clears up resources that have previously been created by `mmrgl.prewarm()`.
	 ...
	 * @example
	 * ```ts
	 * mmrgl.baseApiUrl = 'https://domain.com';
	 * ```
	 */
	 ...
	 * ```ts
	 * mmrgl.addProtocol('custom', (params, callback) => {
	 ...
	 * mmrgl.addProtocol('custom2', (params, callback) => {
	 ...
	 * @example
	 * ```ts
	 * mmrgl.removeProtocol('custom');
	 * ```
	 */
	static removeProtocol(customProtocol: string): void;
}
export type * from "mmr-gl-style-spec";

export {
	MapLibreGL as default,
};

export as namespace mmrgl;
